...
class OpenSSLPrivateKey(six.with_metaclass(abc.ABCMeta)):
    """
    OpenSSLPrivateKey deals with private keys encoded in the OpenSSL
    "traditional" PKCS #1 style format.
    """

    @abc.abstractmethod
    def dump_pem(self, algorithm, mode, kdf, password):
        """
        Dumps self.private_key to PEM.
        """
        pass
    ...
    def private_key(self):
        """
        The underlying asymmetric private key.
        """
