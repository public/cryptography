...
Elliptic curves provide equivalent security at much smaller sizes than
asymmetric cryptography systems such as RSA or DSA. They also can provide
higher performance at every security level. According to NIST they can have as
much as a `64x lower computational cost than DH`_.

.. note::
    Curves with a size of `less than 224 bits`_ are not recommended to be used
    past the year 2010.
